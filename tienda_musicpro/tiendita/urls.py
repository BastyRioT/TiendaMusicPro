...
from .views import index, login, rechazar, registro, pago, entrega, tienda, carro, agregar, eliminar, restar, limpiar, confirmar, sumar, vista_bodeguero, vista_contador, vista_vendedor
